...
import * as animationDataA from '../../../assets/json/pinjump';
import * as animationDataB from '../../../assets/json/TwitterHeart.json';

export default class OtherDemo extends React.Component {
